...
namespace GestionDesStages.Server.Data.Migrations
{
    ...
    [Migration("20221205200640_Modification Stage")]
    partial class ModificationStage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionDesStages.Server.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("GestionDesStages.Shared.Models.Entreprise", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("GestionDesStages.Shared.Models.Etudiant", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("GestionDesStages.Shared.Models.StageStatut", b =>
                {
                    b.Property<int>("StageStatutId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GestionDesStages.Server.Models.ApplicationUser", null)
                        .WithMany()
